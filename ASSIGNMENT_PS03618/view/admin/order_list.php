...
<body>
<h2 style="color:#C00; text-align:center">DANH SÁCH ĐƠN HÀNG</h2>
<br>
<center>
<table class="tbl_list" width="80%" cellpadding="10">
<tr>
    <th style="border-right:#fff dashed 1px;background-color: #000;color: #ffffff;">ID</th>
    <th style="border-right:#fff dashed 1px;background-color: #000;color: #ffffff;">Tên khách hàng</th>
    ...
    <th style="border-right:#fff dashed 1px;background-color: #000;color: #ffffff;">SL</th>
    <th style="border-right:#fff dashed 1px;background-color: #000;color: #ffffff;">Tổng tiền</th>
</tr>
        ...
        $result = $pro->getListPageOrder($start,$display);
        $dem =0;
        while($set = $result->fetch()):
            $dem++;?>
           <center>
             
                <th style="border-right:#000 dashed 1px;line-height: 150px"><?php echo $set['OrderID']?></th>
                <th style="border-right:#000 dashed 1px"><?php echo $set['Customer']?></th>
                <th style="border-right:#000 dashed 1px"><?php echo $set['ProductName']?></th>
                <th style="border-right:#000 dashed 1px"><?php echo $set['ProductPrice']?></th>
                <th style="border-right:#000 dashed 1px"><?php echo $set['Quantity']?></th>
                <th style="border-right:#000 dashed 1px"><?php echo number_format($set['ProductPrice']*$set['Quantity'])?></th>

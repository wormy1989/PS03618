				...
				<div class="wrap">
					...
					<div class="login-right">
						...
						<p>If you have an account with us, please log in.</p>
                                                ...
                                                ?>
                                                Có phải bạn là:<b style="color: red"> <?php echo $_SESSION['username'] ?></b><br/>
                                                <?php echo "<img src='../Controller/images/".$user['Avatar']."' width='50'".'"/>' ?>
                            
						<form method="post" action="?action=login_action" >
		
                                                        <input type="hidden" value="<?php echo $_SESSION['username']?>" name ="txtusername">
                                                        Bạn đã nhập sai password!<br/>Vui lòng nhập lại password!
							<div>
								<span>Password<label>*</label></span>
                                                                <input name="txtpassword" type="password" id="txtpassword" value="" style="width: 97.5%; padding:2% 0 2% 1.5%; opacity: 0.3;"/>
							</div>

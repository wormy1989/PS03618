				...
				<div class="mid-header">
					<div class="wrap">
						...
						<div class="mid-grid-right">
							<a class="logo" href="?action=cpanel"><span> </span></a>
						</div>
						<div class="clear"> </div>
					</div>
				</div>
				...
				<div class="header-bottom">
					...
					<!-- start header menu -->
							<ul class="megamenu skyblue">
                                                                        <li><a class="color2" href="?action=cpanel_list">Quản lý sản phẩm</a>
									</li>
									<li><a class="color3" href="?action=add_product">Thêm sản phẩm</a>
									</li>   
									<li><a class="color4" href="?action=contact_list">Quản lý liên hệ</a>
									</li>

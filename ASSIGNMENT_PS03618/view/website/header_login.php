				...
				<div class="top-header">
					<div class="wrap">
						...
						<div class="top-header-right">  
                                                    <p style="font-size: 0.9em;color: #ff0033; margin-top: -25px;"><span style="font-size: 0.9em;color: #fff";>Wellcome  </span><?php $user = $_SESSION['username']; echo $user ; ?></p>
							<ul>                                                    
								<li><a href="?action=home_logout">Log out</a><span> </span></li>
								<li><a href="?action=register">Join</a></li> 
                                                                <br/>
                                                                <li><a href="?action=myinfo">Thông tin tài khoản</a></li>
							</ul>
						</div>
						<div class="clear"> </div>
					</div>
				...
				<div class="mid-header">
					<div class="wrap">
						...
						<div class="mid-grid-right">
							<a class="logo" href="?action=home_login"><span> </span></a>
						</div>
						<div class="clear"> </div>
					</div>
				</div>
				...
				<div class="header-bottom">
					...
					<!-- start header menu -->
							<ul class="megamenu skyblue">
								<li class="grid"><a class="color2" href="?action=product_login">MEN</a>
									<div class="megapanel">
										<div class="row">
											<div class="col1">
												<div class="h_nav">
					  			...
					  			<li class="active grid"><a class="color4" href="?action=product_login">women</a>
									<div class="megapanel">
										<div class="row">
											<div class="col1">
												<div class="h_nav">
									...
									<li><a class="color5" href="?action=product_login">KIDS</a>
									<div class="megapanel">
										<div class="row">
											<div class="col1">
												<div class="h_nav">
									...
									<li><a class="color6" href="?action=product_login">NIKE SPORTSWEAR</a>
									</li>
									<li><a class="color7" href="?action=contact_login">CONTACT</a>
									</li>
							</ul>
